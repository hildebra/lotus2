...
#versioning
my $selfID = "LotuS 2.03"; #release candidate: 2.0
...
my %clustering_options = (
  ...
  '-count_chimeras<T/F>', 'Add chimeras to count up OTUs/ASVs. (Default: F)'#'Minimum size of dereplicated clustered, one form of noise removal. Can be complex terms like "10:1,3:3" -> meaning at least 10x in 1 sample or 3x in 3 different samples. (Default: 2)',
